...
const ProfilePhotoSelector = ({ image, setImage }) => {
    ...
    return (
        <div className="flex justify-center mb-6">
            ...
            {/* {!image ? (
                <div className="w-20 h-20 flex items-center jusitfy-center bg-purple-100 rounded-full relative">
            ...
            {!image ? (
                <div className="w-20 h-20 flex items-center justify-center bg-purple-100 rounded-full relative">
                 ...
                 rounded-full absolute -bottom-1 -right-1 shadow-md 
                 hover:bg-primary/80 active:scale-95 transition"
                    >
